...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  CAKE = IBEP20(0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa);
...
contract RabbitInu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa; 
    address WBNB = 0xd0A1E359811322d97991E03f863a0C30C2cF029C;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xfD20F1F636dFd4190373CEe9e1bb14155DF8Ce3c;
    ...
    // Name and symbol
    string constant _name = "Rabbit Inu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 980 / 100000; 
    uint256 public _maxSellTxAmount = _totalSupply * 980 / 100000; 
    uint256 public _maxWalletToken = ( _totalSupply * 980 ) / 100000; 
    ...
    uint256 public swapThreshold = _totalSupply * 98 / 100000; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xfD20F1F636dFd4190373CEe9e1bb14155DF8Ce3c;
    ...
    // NOTE: 1% = 100
     function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
        _maxWalletToken = _totalSupply.mul(maxWallPercent).div(100000);
    ...
    function setBuyTxLimitInPercent(uint256 maxBuyTxPercent) external authorized {
        _maxBuyTxAmount = _totalSupply.mul(maxBuyTxPercent).div(100000);
    }

    // Set max sell TX 
    function setSellTxLimitInPercent(uint256 maxSellTxPercent) external authorized {
        _maxSellTxAmount = _totalSupply.mul(maxSellTxPercent).div(100000);
    }
